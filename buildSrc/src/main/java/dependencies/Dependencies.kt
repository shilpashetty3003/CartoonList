...
object Dependencies {
    ...
    object Test{
        const val  testCore="junit:junit:${Versions.coreJunit}"
        const val  testExt="junit:junit:${Versions.testExtJunit}"
        const val  testEspresso="junit:junit:${Versions.espressoCore}"
